...
void BetweenFactorPose3TranslationNorm(const sym::Pose3<Scalar>& a, const sym::Pose3<Scalar>& b,
                                       const Scalar translation_norm, const Scalar sqrt_info,
  ...
  const Scalar _tmp23 = _tmp18 * _tmp2;
