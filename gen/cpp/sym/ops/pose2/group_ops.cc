...
sym::Pose2<Scalar> GroupOps<Pose2<Scalar>>::InverseWithJacobian(const sym::Pose2<Scalar>& a,
  ...
  const Scalar _tmp2 = -_a[0] * _a[3] + _a[1] * _a[2];
  const Scalar _tmp3 = -_a[0];
...
sym::Pose2<Scalar> GroupOps<Pose2<Scalar>>::ComposeWithJacobians(const sym::Pose2<Scalar>& a,
  ...
  const Scalar _tmp3 = _a[1] * _b[3];
  const Scalar _tmp4 = _a[0] * _b[2];
  const Scalar _tmp5 = _a[0] * _b[3] + _a[1] * _b[2];
  const Scalar _tmp6 = std::pow(_tmp2, Scalar(2)) + std::pow(Scalar(_tmp0 - _tmp1), Scalar(2));
...
sym::Pose2<Scalar> GroupOps<Pose2<Scalar>>::BetweenWithJacobians(const sym::Pose2<Scalar>& a,
  ...
  const Scalar _tmp3 = _a[1] * _a[3];
  const Scalar _tmp4 = _a[0] * _a[2];
  const Scalar _tmp5 = _a[0] * _b[2] + _a[1] * _b[3];
  const Scalar _tmp6 = _a[0] * _a[3] - _a[1] * _a[2];
  const Scalar _tmp7 = _a[1] * _b[2];
  const Scalar _tmp8 = _a[0] * _b[3];
  const Scalar _tmp9 = std::pow(_tmp0, Scalar(2)) + std::pow(Scalar(_tmp1 - _tmp2), Scalar(2));
  const Scalar _tmp10 = -_a[0];
  const Scalar _tmp11 = -_a[1];
